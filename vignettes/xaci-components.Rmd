...
`save_dir`/`load_dir` default to `NULL` (a sub-directory of `tempdir()`,
cleared at the end of the session); pass your own persistent directory, as
below, to actually benefit from the cache across sessions:
